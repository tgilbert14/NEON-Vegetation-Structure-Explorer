...
neon_sites <- tibble::tribble(
  ...
  "BART", "D01",  "Bartlett Experimental Forest",                  "NH",   44.0639,  -71.2874,  "Northern hardwood forest in New Hampshire's White Mountains, with beech, birch, and maple on glaciated slopes.",
  ...
  "CPER", "D10",  "Central Plains Experimental Range",             "CO",   40.8155, -104.7456,  "Shortgrass steppe of the Colorado High Plains, with a century of grazing research.",
  ...
  "PUUM", "D20",  "Pu'u Maka'ala Natural Area Reserve",            "HI",   19.5530, -155.3173,  "Tropical montane wet forest on the windward slope of Mauna Loa, Hawai'i, with native ʻōhiʻa and hāpuʻu tree fern."
)
